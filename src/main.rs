...
fn get_swapchain (physical_device: Arc<PhysicalDevice>, surface: Arc<Surface<Window>>, device: Arc<Device>) -> (Arc<Swapchain<Window>>, Vec<Arc<SwapchainImage<Window>>>) {
...
fn main() {
    ...
    let surface = WindowBuilder::new()
        ...
        .unwrap();
    surface.window().set_min_inner_size(Some(LogicalSize::new(200,200)));
    ...
    let (mut swapchain, images) = get_swapchain(physical_device.clone(), surface.clone(), device.clone());
    ...
    event_loop.run(move |event, _, control_flow| match event {
        ...
        Event::WindowEvent {
            ...
            window_resized = true;
            println!("window inner height: {} \n window inner width: {}", surface.window().inner_size().height, surface.window().inner_size().width);
        }
